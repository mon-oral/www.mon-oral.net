...
<a href="https://tchap.gouv.fr/#/room/#monoralnetinvAWBEiaUN:agent.diplomatie.tchap.gouv.fr" target="_blank" role="button" class="mt-4 btn btn-light btn-sm text-left text-muted" style="width:100%;opacity:0.8;">
	<span style="font-size:80%"><i class="fas fa-comment-dots" style="float:left;margin:4px 8px 5px 0px;"></i> salon tchap</span>
</a>
