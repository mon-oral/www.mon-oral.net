<table>
	<tr>
		<td style="width:90%"><a href="/console/activites" role="button" class="btn btn-light text-left text-muted" style="width:100%" data-toggle="tooltip" data-placement="top" title="afficher les activités audio"><span class="small">activités</span></a></td>
		<td><a href="/console/activite-creer" role="button" class="btn btn-light text-dark" data-toggle="tooltip" data-placement="top" title="créer une activité audio pour les élèves (récitation, lecture expressive, description orale...)"><i class="fas fa-plus fa-xs"></i></a></td>
	</tr>
	<tr>
		...
		<td><a href="/console/commentaire-creer" role="button" class="btn btn-light text-dark" data-toggle="tooltip" data-placement="top" title="créer des commentaires audio (correction orale de copies, consignes orales, explications...)"><i class="fas fa-plus fa-xs"></i></a></td>
	</tr>
	<tr>
...
<a href="https://github.com/mon-oral/www.mon-oral.net/discussions" target="_blank" role="button" class="mt-4 btn btn-light btn-sm text-left text-muted" style="width:100%;opacity:0.8;" data-toggle="tooltip" data-placement="top" title="remarque : un compte GitHub est nécessaire">
...
<a href="https://github.com/mon-oral/www.mon-oral.net/issues/new/choose" target="_blank" role="button"  class="mt-1 btn btn-light text-left btn-sm text-muted" style="width:100%;opacity:0.8;" data-toggle="tooltip" data-placement="top" title="remarque : un compte GitHub est nécessaire">
