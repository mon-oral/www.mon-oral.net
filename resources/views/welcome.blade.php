...
<body>
	...
	<div class="container">
		...
		<div class="row">
			...
			<div class="col-md-3 offset-md-2 text-muted mt-4">
			...
			<div class="col-md-4 offset-md-1 text-muted mt-4 order-first order-md-last">
				<!-- ENREGISTREMENT -->
				<div id="interface" class="text-center mb-4 h-100 d-inline-block" style="width:100%;border:4px dashed #e8eaeb;border-radius:8px;padding:10px;position:relative">
					<div style="position:absolute;top:10px;right:12px;cursor:help;">
					<i style="color:silver" class="fas fa-question-circle" data-placement="top" data-html="true" data-trigger="hover" data-toggle="popover" data-content="Enregistrement libre de capsules audio pour des travaux scolaires, des préparations aux épreuves orales, des émissions webradio, la création de podcasts ou pour s'entraîner à l'oral de façon autonome."></i>
					</div>
					<div id="start_rec">
						<div class="p-2"><span id="chrono" class="chrono">00:00</span></div>
						<div class="pb-3 text-monospace text-danger small" style="opacity:0.5" id="max">20 minutes maximum</div>
						<a href="/capsule" id="start_button" type="button" class="btn btn-success pt-2 mt-3 btn-lg"><i class="material-icons align-middle">&#xe31d</i></a>
						<div id="start_label" class="small mt-4 text-muted text-monospace">enregistrer et partager<br />une capsule audio</div>
					</div>
		...
		<div class="row mt-5">
			...
			<div class="col-md-8 offset-md-2 mt-5" style="background-color:#f2f4f6;border-radius:6px;padding:10px 22px 14px 22px;">
				...
				<div class="card-deck">
					...
					<div class="card" style="margin-left:7px;margin-right:7px;">
						...
						<div class="card-body pt-0">
							<p class="card-text">
								...
								<h3>récitation, lecture expressive,<br />explications orales...</h3>
							</p>
							<div class="text-center text-monospace mt-2"><a class="btn btn-light btn-sm" href="/console/activite-creer" role="button">créer une activité</a></div>
						</div>
					</div>
					...
					<div class="card" style="margin-left:7px;margin-right:7px;">
						...
						<div class="card-body pt-0">
							...
							<div class="text-center text-monospace mt-2"><a class="btn btn-light btn-sm" href="/console/entrainement-creer" role="button">créer un entraînement</a></div>
						</div>
					</div>
