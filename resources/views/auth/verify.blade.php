            ...
            <div class="card mt-5 text-muted" style="background:none;border:none;">
                ...
                <div class="card-body">
                    ...
                    <ul>
                        ...
                        <li class="mt-3">
                        Si vous avez commis une erreur lors de l'inscription (adresse courriel erronée par exemple), complétez une <a href="/direct-inscription" class="button text-center">nouvelle inscription</a>.
                        </li>
                        <li class="mt-3">
                        Si vous avez reçu le courriel de vérification, que vous avez cliqué sur le lien mais que vous arrivez tout de même sur cette page, <a href="/direct-connexion" class="button text-center">cliquez ici</a> pour vous connecter.
                        </li>
                        <li class="mt-3">
                        Si un problème persiste et vous empêche de vous connecter, vous pouvez écrire à <a href="mailto:contact@mon-oral.net">contact@mon-oral.net</a>.
                        </li>
                    </ul>
                </div>
            </div>
