									...
									foreach($entrainements as $entrainement) {
										...
										<div id="card_{{ $entrainement->id }}"  style="opacity:{{ $opacity }}" class="card mb-2">
											...
											<div class="card-body p-3">
												...
												<!-- options -->
												<div style="position:absolute;right:8px;top:8px;"><a tabindex="0" role="button" class="text-muted" style="cursor:pointer;outline:none;" data-trigger="focus" data-container="body" data-toggle="popover" data-placement="left" data-html="true" data-content="<a class='btn btn-light btn-sm m-1' href='/console/entrainement-modifier/{{ $entrainement->id }}' role='button'>modifier</a><a class='btn btn-light btn-sm m-1' href='/console/entrainement-statut/{{ $entrainement->id }}' role='button'>{{ $action }}</a><a class='btn btn-light btn-sm m-1' href='/console/entrainement-archiver/{{ $entrainement->id }}' role='button'>{{ $archiver }}</a>"><i class="fas fa-ellipsis-v"></i></a>
